    ...
    function ENT:Touch(toucher)
        ...
        if toucher:IsPlayer() then
            ...
            timer.Simple(0.15, function()
                ...
                toucher.JumpLock = true
            end)

            print("[SOAP] Set " .. toucher:Nick() .. " JumpLock = true")

            if toucher.GetJumpLevel and toucher.GetMaxJumpLevel then
                toucher:SetJumpLevel(toucher:GetMaxJumpLevel())
                print("[SOAP] Set " .. toucher:Nick() .. " jump level to " .. toucher:GetJumpLevel())
            end
