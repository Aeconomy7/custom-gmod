...
local bgcolor = Color(10, 20, 35, 150)  -- dark navy (matches site background)
...
function PANEL:Paint()
    ...
    -- Alternating row background (subtle gold tint)
    local y = 24
    ...
    for i = 1, #self.rows_sorted do
        ...
        if i % 2 ~= 0 then
            surface.SetDrawColor(255, 224, 102, 18)  -- very subtle gold tint
