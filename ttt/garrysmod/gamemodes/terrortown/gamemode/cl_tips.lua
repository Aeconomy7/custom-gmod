...
function PANEL:Init()
   ...
   self.tiptext:SetText(GetTranslation("tips_panel_title") or "")
...
function PANEL:SetTip(idx)
   ...
   if not self.tiptext then return end
   self.tiptext:SetText((GetTranslation("tips_panel_tip") or "") .. " " .. (text or ""))
...
function PANEL:PerformLayout()
   if not self.bwrap or not self.buttons or not self.tiptext then return end
   local m = 8
   local off_bottom = 10
...
function PANEL:ApplySchemeSettings()
   if not self.buttons or not self.bwrap or not self.tiptext then return end
...
function PANEL:Think()
   if not self.NextSwitch then return end
