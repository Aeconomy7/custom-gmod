...
function PLAYER:Loadout()
	...
	if ( cvars.Bool( "sbox_weapons", true ) ) then
		...
		-- self.Player:GiveAmmo( 20,	"SniperPenetratedRounds", true )
		-- self.Player:GiveAmmo( 64,	"Buckshot", 	true )
		-- self.Player:GiveAmmo( 32,	"357", 			true )
		-- self.Player:GiveAmmo( 0,	"XBowBolt", 	true )
		-- self.Player:GiveAmmo( 6,	"AR2AltFire", 	true )
		-- self.Player:GiveAmmo( 100,	"AR2", 			true )
		
		-- self.Player:Give( "bb_css_knife" )
		-- self.Player:Give( "bb_usp" )
		-- self.Player:Give( "bb_css_smoke" )
		-- self.Player:Give( "bb_m3" )
		-- self.Player:Give( "bb_m4a1" )
		-- self.Player:Give( "bb_awp" )
	...
	if ( cvars.Bool( "sbox_instagib", true ) ) then
	
	-- self.Player:GiveAmmo( 900,	"AR2", 			true )
	
	-- self.Player:Give( "weapon_asmd_instagib" )
end
