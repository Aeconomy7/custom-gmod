...
local speedColorStops = {
    [0]    = Color(255,   0,   0),   -- Red
    [600]  = Color(255, 140,   0),   -- Orange
    [1200] = Color(255, 255,   0),   -- Yellow
    [1800] = Color(0,   255,   0),   -- Green
    [2400] = Color(0,   200, 255),   -- Bright Cyan-Blue
    [3000] = Color(120,   0, 255),   -- Bright Indigo
    [3600] = Color(200,   0, 255),   -- Bright Violet
    [4200] = Color(255, 255, 255),   -- White
}
