...
-----------------------------------------------------------]]
local deathsounds = {
    Sound("death_sounds/bababooey.mp3"),
    Sound("death_sounds/coconutbonk.mp3"),
    Sound("death_sounds/dark-souls_death.mp3"),
    Sound("death_sounds/dark-souls_you-died.mp3"),
    Sound("death_sounds/death_fuckyou.mp3"),
    Sound("death_sounds/dwightdeath.mp3"),
    Sound("death_sounds/generic2_death.mp3"),
    Sound("death_sounds/goofy_scream.mp3"),
    Sound("death_sounds/lego_yoda_death_sound.mp3"),
    Sound("death_sounds/luigi_death.mp3"),
    Sound("death_sounds/mk_pain1.mp3"),
    Sound("death_sounds/morrowind_fall.mp3"),
    Sound("death_sounds/no_hd.mp3"),
    Sound("death_sounds/nonoahhh_death.mp3"),
    Sound("death_sounds/oof.mp3"),
    Sound("death_sounds/ouch.mp3"),
    Sound("death_sounds/pizza_italiano.mp3"),
    Sound("death_sounds/primal_death.mp3"),
    Sound("death_sounds/pumpkin_smash.mp3"),
    Sound("death_sounds/quack.mp3"),
    Sound("death_sounds/raggle_death.mp3"),
    Sound("death_sounds/runescape_you-are-dead.mp3"),
    Sound("death_sounds/ryu_death.mp3"),
    Sound("death_sounds/sonic_damage.mp3"),
    Sound("death_sounds/spongebob_my-leg.mp3"),
    Sound("death_sounds/tom_death1.wav"),
    Sound("death_sounds/tom_death2.wav"),
    Sound("death_sounds/tom_death3.wav"),
    Sound("death_sounds/tom_death4.wav"),
    Sound("death_sounds/tom_death5.wav"),
    Sound("death_sounds/tourettes-guy_FUCK_long.mp3"),
    Sound("death_sounds/wario_death.mp3"),
    Sound("death_sounds/wilhelm_scream.mp3"),
    Sound("death_sounds/wukong_lol_death.mp3")
}
...
function GM:GetFallDamage( ply, flFallSpeed )
	...
	sound.Play( "death_sounds/legobreaking.mp3", ply:GetPos(), 75, 100 )
